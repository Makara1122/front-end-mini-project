...
let createCard = (product) => {
    ...
    <div class="p-5">
        <a href="#">
            <h5 class="group-hover:text-white mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">${product.price}</h5>
        </a>
        <p class="group-hover:text-white mb-3 font-normal text-gray-700 dark:text-gray-400">${product.description}</p>
